<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="ABlogUpdate.aspx.cs" Inherits="FilmBlog.AdminPages.ABlogUpdate" %>
        ...
        <div class="container">
            ...
            <form runat="server" class="form-group">
                ...
                <div class="form-group">
                    ...
                    <asp:TextBox ID="txtbasliq" CssClass="form-control" runat="server"></asp:TextBox>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <asp:TextBox ID="txtTarix"  CssClass="form-control" runat="server"></asp:TextBox>
                </div>
                <div class="form-group">
                    <label style="font-weight: bolder">Media:</label>
                    <asp:TextBox ID="txtMedia"  CssClass="form-control" runat="server"></asp:TextBox>
                </div>
                <div class="form-group">
